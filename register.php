...
<html>
	<head>
		...
		<title>Register | Biology Education Quiz</title>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Biology Edu Quiz</h4></center><br>
