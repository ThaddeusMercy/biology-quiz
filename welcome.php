...
<head>
    ...
    <title>Welcome | Biology Education Quiz</title>
...
<body>
    ...
    <!-- You know I'll always find a way to add a modal :) -->
    <div class="quick-modal" id="quick-modal">
        <div class="quick-modal-content-container">
            
            <div><span class="dark-text px20 bold" id="read-course-title"></span></div>
            
            <div><span class="faded px14" id="read-course-description"></span></div>

            <div><span class="btn-sm bg-black white" onclick="closeModal('quick-modal')">Close</span></div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Biology Education Quiz</b></a>
        </div>
            ...
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    <tr><td><center><b>S.N.</b></center></td>
                        ...
                        <td><center><b>Read Description</b></center></td>
                    ...
                    if($rowcount == 0){
                        echo '<tr>
                            <td><center>'.$c++.'</center></td>
                                ...
                                <td><center><b><a href="javascript:void(0)" onclick="readCourse(this.lang, this.title)" lang="' . $title . '" title="' . $description . '" class="btn sub1" style="color:black;margin:0px;background:#1de9b6"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Read</b></span></a></b></center></td>
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $r=$row['sahi'];
                            $qa=$row['level'];
                            echo '<tr style="color:#66CCFF"><td>Total Questions</td>
                                <td>'.$qa.'</td>
                                </tr>
                                <tr style="color:#99cc32"><td>right Answer&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td>
                                    <td>'.$r.'</td>
                                    </tr> 
                                <tr style="color:red"><td>Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></td>
                                    <td>'.$w.'</td>
                                    </tr>
                                <tr style="color:#66CCFF"><td>Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td>
                                    <td>'.$s.'</td>
                        ...
                        {
                            $s=$row['score'];
                            echo '<tr style="color:#990000"><td>Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td>
                                <td>'.$s.'</td>
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><td><center><b>S.N.</b></center></td>
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        <table class="table table-striped title1" >
                        <tr style="color:red"><td><center><b>Rank</b></center></td>
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $c++;
                            echo '<tr><td style="color:black"><center><b>'.$c.'</b></center></td>
