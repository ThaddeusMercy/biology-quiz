...
<head>
    ...
    <title>Dashboard | Biology Education Quiz</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Biology Education Quiz</b></a>
            </div>
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 control-label" for="name"></label>  
                                    <div class="col-md-12">
                                        <textarea id="description" name="description" placeholder="Enter Quiz description" class="form-control input-md" type="text"></textarea>
                                    </div>
                                </div>
