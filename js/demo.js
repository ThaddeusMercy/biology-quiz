...
for (var i = toggler.length - 1; i >= 0; i--) {
 ...
 /**
	* Read course details
	...
	@param description
	*/
 function readCourse(courseTitle, description) {
	document.getElementById('read-course-title').innerText = courseTitle
	document.getElementById('read-course-description').innerText = description
